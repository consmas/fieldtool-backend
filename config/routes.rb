  ...
  scope defaults: { format: :json } do
    ...
    namespace :api do
      namespace :v1 do
        ...
        delete "fuel/deposits/:id", to: "/fuel/deposits#destroy"
        ...
        get "trips/:trip_id/pre_trip", to: "/trips/pre_trips#show"
        post "trips/:trip_id/pre_trip", to: "/trips/pre_trips#create"
        patch "trips/:trip_id/pre_trip", to: "/trips/pre_trips#update"
        patch "trips/:trip_id/pre_trip/verify", to: "/trips/pre_trip_verifications#update"
        patch "trips/:trip_id/pre_trip/confirm", to: "/trips/pre_trip_verifications#confirm"
        patch "trips/:trip_id/fuel_allocation", to: "/trips/fuel_allocations#update"
        patch "trips/:trip_id/road_expense", to: "/trips/road_expenses#update"
        patch "trips/:trip_id/road_expense/receipt", to: "/trips/road_expenses#receipt"
