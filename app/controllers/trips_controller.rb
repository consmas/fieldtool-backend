class TripsController < ApplicationController
  ...
  def trip_payload(trip, include_latest_location: false, include_events: false)
    payload = {
      ...
      delivery_place_id: trip.delivery_place_id,
      delivery_lat: trip.delivery_lat,
      delivery_lng: trip.delivery_lng,
      delivery_map_url: trip.delivery_map_url,
      delivery_location_source: trip.delivery_location_source,
      delivery_location_resolved_at: trip.delivery_location_resolved_at,
      ...
      road_expense_receipt_url: attachment_url(trip.road_expense_receipt),
